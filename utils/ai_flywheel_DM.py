import os
# 设置环境变量为GM，确保使用GM配置
os.environ['AUDIO_CLASSIFY_DATA_MODE'] = 'DM'
...
class AIFlywheel:
    ...
    def _generate_hdf5(self):
        ...
        command = [
            ...
            "--csv_path", "dataset_root_DM/metadata/gk_train_segments.csv",
            "--audios_dir", "dataset_root_DM/audios/balanced_train_segments",
            "--waveforms_hdf5_path", "dataset_hdf5_DM/hdf5s/waveforms/balanced_train.h5"
        ]
    ...
    def _generate_indexes(self):
        ...
        command = [
            ...
            "--waveforms_hdf5_path", "dataset_hdf5_DM/hdf5s/waveforms/balanced_train.h5",
            "--indexes_hdf5_path", "dataset_hdf5_DM/hdf5s/indexes/balanced_train.h5"
        ]
    ...
    def _trigger_model_training(self, checkpoint_path=None):
        ...
        try:
            ...
            # 获取源文件路径
            source_checkpoint_name = "MobileNetV2_Mod_DM"
    ...
    def scan_and_process(self):
        ...
        if increment >= self.increment_threshold:
            ...
            if self._trigger_data_compression():
                # 数据集压缩成功后，触发模型训练
                self._trigger_model_training("MobileNetV2_Mod_DM.pth")
